        ...
        <header className="sm:flex sm:justify-between sm:items-center sm:px-4 sm:py-2">
			...
			<div className="px-4 pb-2 items-center flex">
				...
				>
					...
					<NavLink to="/promise" className="mt-1 block py-1 underline-anim underline-animate sm:mt-0 sm:ml-4  text-primary">
							Promise
						</NavLink>
						<NavLink to="/becomeAsponser" className="mt-1 block py-1 underline-anim underline-animate sm:mt-0 sm:ml-4  text-primary">
						Become A Sponser
					</NavLink>
